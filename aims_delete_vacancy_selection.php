<html>
    <head>
        <meta charset="UTF-8">
        <title>Select Vacancy - AIMS</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="POST" action="validateVacancyNumber_Delete.php">
                        <h2><center>Select Vacancy</center></h2>
                        <br>
                        <br>
                        <div class="single">  
                            <div class="form-container">
                                ...
                                <div class="control-group form-group">
                                    <div class="controls">
                                        ...
                                        <input type="text" class="form-control" name="validateVCNumber" id="iname" required="">
                                        <br><br>	
                                        <div class="success">
                                            <button type="submit" name="btnValidateVCNumber" value="Search" class="btn btn-primary btn-block">Validate Student NIC</button>
                                            <br>
                                            </form>
                                        </div>
                                    </div>
