<html>
    <head>
        <meta charset="UTF-8">
        <title>Verify Student - AIMS</title>
...
<?php
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="POST" action="validateStudentNIC_Enroll.php">
                        <h2><center>Student Verification</center></h2>
                        <br>
                        <br>
                        <div class="single">  
                            <div class="form-container">
                                ...
                                <div class="control-group form-group">
                                    <div class="controls">
                                        ...
                                        <input type="text" class="form-control" name="validateStNIC" id="iname" required="">
                                        <br><br>	
                                        <div class="success">
                                            <button type="submit" name="btnValidateStudentNIC" value="Search" class="btn btn-primary btn-block">Validate Student NIC</button>
                                            <br>
                                            </form>
                                        </div>
                                    </div>
